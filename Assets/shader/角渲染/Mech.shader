Shader "GZH/Mech"
{
    Properties
    {
        ...
        [MainTexture] _SubTex("Sub Texture", 2D) = "white" {}
        [MainTexture] _SmoothTex("Smooth Texture", 2D) = "white" {}
        [MainTexture] _CurveTex("Curve Texture", 2D) = "white" {}
        [MainTexture] _SSSLUT("SSS LUT", 2D) = "white" {}
        [MainTexture] _KelemenLUT("Kelemen LUT", 2D) = "white" {}

        [KeywordEnum(OFF,ON)] SSS("SSS Mode", Float) = 1
        [KeywordEnum(Const,Calu,Tex)] Curve("Use Curve Texture", Float) = 1
